export default {
  ...
  cta: {
    ...
    pitch03: "채팅 사이 복사 붙여넣기 그만",
    pitch04: "AI는 답한다. NODUS는 기억한다.",
    pitch05: "그 답변을 다시 찾을 수 없나요?",
    pitch06: "답변을 재사용 가능한 지식으로",
    pitch07: "맥락을 잃지 않고 아이디어를 재사용",
    pitch08: "최고의 AI 답변, 그 다음은요?",
    pitch09: "소중한 답변을 채팅에 묻어두지 마세요",
    pitch10: "포착하고. 정리하고. 재사용하라.",
    pitch11: "값진 답변을 찾았나요? 저장하세요.",
