export default {
  ...
  watch: {
    ...
    pinMatch:        "Закрепить этот пост, чтобы отслеживать"
  },
  cta: {
    lostAIPitch: "Теряете беседы с ИИ?",
    lostAITitle: "Открыть NODUS — сохранить беседы с ИИ",
    pitch01: "Теряете ответы ИИ?",
    pitch02: "Соберите лучшие ответы ИИ в одном месте",
    pitch03: "Хватит копировать между чатами",
    pitch04: "ИИ отвечает. NODUS помнит.",
    pitch05: "Не можете снова найти тот ответ?",
    pitch06: "Превратите ответы в знания для повторного использования",
    pitch07: "Используйте идеи повторно, не теряя контекст",
    pitch08: "Что станет с вашими лучшими ответами ИИ?",
    pitch09: "Ваши лучшие ответы не должны застревать в чате",
    pitch10: "Сохрани. Упорядочи. Используй снова.",
    pitch11: "Нашли ценный ответ? Сохраните его.",
