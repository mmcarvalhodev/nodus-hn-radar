export default {
  ...
  watch: {
    ...
    errMaxReached:   "Достигнут предел в 5 правил. Удалите одно, чтобы добавить новое.",
    capHint:         "Все {max} слотов заняты — удалите правило, чтобы добавить новое.",
    toggleHint:      "Включить или выключить это правило"
  },
  cta: {
