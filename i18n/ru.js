export default {
  ...
  cta: {
    ...
    pitch03: "Хватит копировать между чатами с ИИ",
    pitch04: "ИИ отвечает. NODUS помнит.",
    pitch05: "Не можете снова найти тот ответ ИИ?",
    pitch06: "Превратите ответы ИИ в знания для повторного использования",
    pitch07: "Используйте идеи ИИ повторно, не теряя контекст",
